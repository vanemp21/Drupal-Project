  ...
  Drupal.behaviors.userList = {
    attach: function (context, settings) {
      ...
      function loadPage(page) {
        ...
        console.log(
          "Cadena de consulta para la página",
          page,
          ":",
          queryString
        ); // Para depuración
