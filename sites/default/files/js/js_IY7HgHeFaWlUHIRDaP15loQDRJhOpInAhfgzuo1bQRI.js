...
(function ($, Drupal) {
  Drupal.behaviors.userList = {
    attach: function (context, settings) {
      $('#search-form', context).once('userList').on('submit', function (e) {
        e.preventDefault();
        ...
        // Realizar la solicitud AJAX con los valores de los filtros
        $.ajax({
          url: Drupal.url('ajax/user-list'),
          type: 'GET',
          data: {
            name: name,
            surname: surname,
          ...
          success: function (data) {
            // Renderiza los datos devueltos en el contenedor
